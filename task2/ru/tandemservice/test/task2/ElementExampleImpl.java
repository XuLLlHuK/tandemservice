...
public final class ElementExampleImpl implements IElement
{
	 ...
	 */
	public ElementExampleImpl(final Context context,
			final int number)
	{
	...
	private void setNumber(final int number)
	{
		if (null != this.number)
		{
			if (this != this.context.uniqueMap
					.remove(this.number))
			{
		...
		final ElementExampleImpl old = this.context.uniqueMap
				.put(this.number = number, this);
		if (null == old)
		{
			return;
		}
